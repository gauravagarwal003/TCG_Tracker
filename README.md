...
The `docs/` folder is served via GitHub Pages using Firebase Google Auth. Shared static assets (like mappings and prices) are generated by the daily job.

## Deployment Quick Start (Free)

1. Configure GitHub Pages to deploy from `main` -> `/docs`
